...
namespace Application.Activities.Queries
{
    public class GetActivityList
    {
        ...
        public class Handler(AppDbContext context, IMapper mapper) : IRequestHandler<Query, List<ActivityDto>> //Always takes Query + whatever we are returning. Note we had to manually add AppDbContext since we will need to access the DB to return the data in Handle()
        {
